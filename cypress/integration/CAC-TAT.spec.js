...
describe('Central de Atendimento ao Cliente TAT', function () {
  const TRES_SEGUNDOS_EM_MILISEG = 3000
  ...
  Cypress._.times(5, function () {
    it('preenche os campos obrigatórios e envia o formulário', function () {
      ...
      cy.tick(TRES_SEGUNDOS_EM_MILISEG)
  ...
  //esse teste simula a ação de arrastar o arquivo de uma pasta para upload validando se o mesmo foi anexado
  ...
  it.only('encontrar o gato escondido, mudar o titulo da página para "CAT TAT" e o subtitulo "Eu amo gatos!"', function () {
    cy.get('#cat')
      .invoke('show')
      .should('be.visible')
    cy.get('#title')
